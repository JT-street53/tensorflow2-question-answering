...
#### configs original ####
flags.DEFINE_string("VERSION", "ALBERT001",
...
flags.DEFINE_string("ADDITIONAL_VOCAB_FILE", 
                    "/home/ec2-user/SageMaker/src/ALBERT_NaturalQuestion/weights/vocab-nq_ADDITIONAL.txt", 
                    "The directory where tokenizer model weight file is available.")
flags.DEFINE_string("TOKENIZER_MODEL_PATH_XLARGE", 
                    "/home/ec2-user/SageMaker/src/ALBERT_NaturalQuestion/weights/albert-xlarge-v2-spiece.model", 
                    "The directory where tokenizer model weight file is available.")
flags.DEFINE_string("PRETRAINED_MODEL_PATH_XLARGE", 
                    "/home/ec2-user/SageMaker/src/ALBERT_NaturalQuestion/weights/albert-xlarge-v2-tf_model.h5", 
...
flags.DEFINE_string("MODEL_VERSION", "albert-xlarge-v2", "model version.")
...
flags.DEFINE_bool("DO_LOWER_CASE", True, "Whether or not to do lower case for preprocessing.")
...
flags.DEFINE_integer("BATCH_ACCUMULATION_SIZE", 24, "Batch accumulation size for training.")
